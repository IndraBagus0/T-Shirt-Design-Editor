        ...
        <section id="typography">
            ...
            <div class="row">
                <div class="span7">
                    ...
                    <div style="min-height: 32px; margin-bottom: 10px;">
                        <div class="clearfix">
                            <div class="pull-right" align="" id="imageeditor">
                                <div class="btn-group">
                                    <button class="btn" id="bring-to-front" title="Bring to Front">
                                        <i class="icon-fast-backward rotate"
                                            style="display: block; height:19px; margin: 0 auto;"></i>
                                        <span style="display: block; text-align: center;">Bring to Front</span>
                                    </button>
                                    <button class="btn" id="send-to-back" title="Send to Back">
                                        <i class="icon-fast-forward rotate"
                                            style="display: block; height:19px; margin: 0 auto;"></i>
                                        <span style="display: block; text-align: center;">Send to Back</span>
                                    </button>
                                    <button id="flip" type="button" class="btn" title="Show Back View">
                                        <i class="icon-retweet"
                                            style="display: block; height:19px; margin: 0 auto;"></i>
                                        <span style="display: block; text-align: center;">Show Back/Font</span>
                                    </button>
                                    <button id="remove-selected" class="btn" title="Delete selected item">
                                        <i class="icon-trash" style="display: block; height:19px; margin: 0 auto;"></i>
                                        <span style="display: block; text-align: center;">Delete</span>
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="span5">
                    <div class="tabbable">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#tab2" data-toggle="tab">Input Text</a></li>
                            <li><a href="#tab3" data-toggle="tab">Add image</a></li>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab1">
                                <div class="well">
                                    <h2>Select Color</h2>
                                    <ul class="nav">
                                        <li class="color-preview" title="White" style="background-color:#ffffff;"
                                            value="white"></li>
                                        <li class="color-preview" title="Dark Heather" style="background-color:#616161;"
                                            value="dark heather"></li>
                                        <li class="color-preview" title="Gray" style="background-color:#f0f0f0;"
                                            value="gray"></li>
                                        <li class="color-preview" title="Charcoal" style="background-color:#5b5b5b;"
                                            value="charcoal"></li>
                                        <li class="color-preview" title="Black" style="background-color:#222222;"
                                            value="black"></li>
                                        <li class="color-preview" title="Heather Orange"
                                            style="background-color:#fc8d74;" value="heather orange"></li>
                                        <li class="color-preview" title="Heather Dark Chocolate"
                                            style="background-color:#432d26;" value="heather dark chocolate"></li>
                                        <li class="color-preview" title="Salmon" style="background-color:#eead91;"
                                            value="salmon"></li>
                                        <li class="color-preview" title="Chesnut" style="background-color:#806355;"
                                            value="chesnut"></li>
                                        <li class="color-preview" title="Dark Chocolate"
                                            style="background-color:#382d21;" value="dark chocolate"></li>
                                        <li class="color-preview" title="Citrus Yellow"
                                            style="background-color:#faef93;" value="citrus yellow"></li>
                                        <li class="color-preview" title="Avocado" style="background-color:#aeba5e;"
                                            value="avocado"></li>
                                        <li class="color-preview" title="Kiwi" style="background-color:#8aa140;"
                                            value="kiwi"></li>
                                        <li class="color-preview" title="Irish Green"
                                            style="background-color:#1f6522;" value="irish green"></li>
                                        <li class="color-preview" title="Scrub Green"
                                            style="background-color:#13afa2;" value="scrub green"></li>
                                        <li class="color-preview" title="Teal Ice" style="background-color:#b8d5d7;"
                                            value="teal ice"></li>
                                        <li class="color-preview" title="Heather Sapphire"
                                            style="background-color:#15aeda;" value="heather sapphire"></li>
                                        <li class="color-preview" title="Sky" style="background-color:#a5def8;"
                                            value="sky"></li>
                                        <li class="color-preview" title="Antique Sapphire"
                                            style="background-color:#0f77c0;" value="antique sapphire"></li>
                                        <li class="color-preview" title="Heather Navy"
                                            style="background-color:#3469b7;" value="heather navy"></li>
                                        <li class="color-preview" title="Cherry Red"
                                            style="background-color:#c50404;" value="cherry red"></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab2">
                                <div class="well">
                                    <div class="input-append">
                                        <input class="input-text span4" id="text-string" type="textarea"
                                            placeholder="Add Text Here...">
                                        <button id="add-text" class="button-text" title="Add text">Add Text</button>
                                    </div>
                                </div>
                                <div class="well" id="texteditor" style="display:none">
                                    <div class="btn-group inline pull-left">
                                        <button id="font-family" class="btn" data-toggle="modal"
                                            data-target="#fontModal" title="Font Style">
                                        ...
                                        <button id="text-strike" class="btn" title="Strike"><img
                                                src="img/font_strikethrough.png" height=""
                                                width=""></button>
                                        <button id="text-underline" class="btn" title="Underline"><img
                            ...
                            <div id="fontModal" class="modal fade" tabindex="-1" role="dialog">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Select Font</h4>
                                        </div>
                                        <div class="modal-body">
                                            <ul aria-labelledby="font-family-X">
