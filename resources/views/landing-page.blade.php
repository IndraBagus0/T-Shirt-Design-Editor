        ...
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                <div class="relative">
                    ...
                    <div id="productMenu"
                        class="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5 opacity-0 translate-y-1 hidden transition ease-in-out duration-200">
                        <div class="p-4">
                            <div
...
<script>
    ...
    button.addEventListener('click', () => {
        ...
        // Toggle visibility and transition classes
        if (isExpanded) {
            menu.classList.add('opacity-0', 'translate-y-1');
            setTimeout(() => {
                menu.classList.add('hidden');
            }, 150); // Delay sesuai dengan durasi animasi keluar (150ms)
        } else {
            menu.classList.remove('hidden');
            setTimeout(() => {
                menu.classList.remove('opacity-0', 'translate-y-1');
            }, 10); // Sedikit delay agar transisi berjalan dengan benar
        }
    });
</script>
